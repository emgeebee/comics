...
function bartik_preprocess_html(&$variables) {
	if($variables['theme_hook_suggestions'][0] == "html__comics"){
		array_push($variables['theme_hook_suggestions'], "page__comics");
		array_push($variables['theme_hook_suggestions'], "node__comics");
  ...
  drupal_add_js(path_to_theme() . '/scripts/jquery.booklet.1.2.0.min.js');
